...
export default function SimpleDataMethod({
    id,
    data,
}: {
    id: string
                ...
                <div>
                    <Handle
                        ...
                        style={{
                            ...
                            backgroundColor: data.sourceSimpleData
                                ? "green"
                                : "#ff6666",
                        }}
                    />
                    <Handle
                        ...
                        style={{
                            ...
                            backgroundColor: data.sourceSimpleDataB
                                ? "green"
                                : "#ff6666",
                        }}
                    />
                ...
                htmlOutput.length > 300 ? (
                    ...
                    >
                        ...
                        <input
                            ...
                            style={{ width: 50 }}
                            onChange={(evt) =>
                                setHTMLOutputLength(parseInt(evt.target.value))
                            }
                            defaultValue={300}
                        />
                    </div>
                ) : null}
                {data.method === "showTable" && data.simpleData ? (
                    <>
                        <Table
                            keys={data.simpleData.getKeys()}
